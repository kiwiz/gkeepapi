...
class KeepAPI(API):
    ...
    def changes(self, target_version:str=None, nodes:List[Dict]=None, labels:List[Dict]=None) -> Dict:
...
class Keep(object):
    ...
    def resume(self, email: str, master_token: str, state: Optional[Dict] = None, sync=True, device_id: Optional[str] = None):
